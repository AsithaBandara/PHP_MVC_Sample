...
if (Session::get('role') == 'admin') {
    ...
    <div class="col-sm-10">
        ...
        <div class="project_manager">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <p><button type="button" class="btn btn-default btn-sm btn-block" data-toggle="modal" data-target="#add_manager">Add New Manager</button></p>
                </div>
                    ...
                    foreach ($this->ManagerList as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo URL . "Manager/edit/" . $value['id']; ?>" ><button class="btn ">Edit</button></a>

                                <a href="<?php echo URL . "Manager/delete/" . $value['id']; ?>"><button class="btn ">Remove</button></a>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="post" action="<?php echo URL; ?>Manager/create">
